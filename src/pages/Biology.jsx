...
import { ArrowLeft, BookOpen, Layers, Play, Clock, Sparkles } from 'lucide-react';
import { subjects } from '../data/curriculum';

export default function Biology() {
  const navigate = useNavigate();
  const data = subjects.biology;
  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-950/45 to-teal-950/45 border border-emerald-500/20 p-6 sm:p-8"
      >
        ...
        <div className="relative z-10 space-y-3">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
            Explore <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-300">{data.title}</span>
          </h1>
        ...
        >
          {data.topics.map((topic) => (
            <motion.div
              ...
              className="group cursor-pointer glass-panel rounded-xl p-6 flex flex-col justify-between hover:border-emerald-500/30 transition-colors"
            >
              <div>
              ...
              <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between text-xs text-gray-500">
                ...
                <span className="flex items-center gap-1 font-bold text-emerald-400 group-hover:text-emerald-300 transition-colors">
                  Open Topic
