  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-violet-400 bg-violet-500/10 px-3 py-1 rounded-full border border-violet-500/20">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-violet-950/45 to-fuchsia-950/45 border border-violet-500/20 p-6 sm:p-8"
      >
        ...
        <div className="relative z-10 space-y-3">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
            Explore <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">{data.title}</span>
          </h1>
        ...
        >
          {data.topics.map((topic) => (
            <motion.div
              ...
              className="group cursor-pointer glass-panel rounded-xl p-6 flex flex-col justify-between hover:border-violet-500/30 transition-colors"
            >
              <div>
              ...
              <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between text-xs text-gray-500">
                <span className="flex items-center gap-1">
                  <BookOpen className="h-3.5 w-3.5 text-violet-500/70" />
                  {topic.lessons.length} Lessons
                </span>
                <span className="flex items-center gap-1 font-bold text-violet-400 group-hover:text-violet-300 transition-colors">
                  Open Topic
